...
cron.schedule(
  ...
  async () => {
    try {
      ...
      // ✅ 제목 포맷: ❤ 11-06 (목) 21시00분 협곡내전 ❤
      const date = now.format("MM-DD");
      const title = `❤ ${date} (${weekday}) 21시00분 협곡내전 ❤`;
...
✅ 내전 이름 빼기 관련 '내전규칙' 채널 참고 내전 시작 시간 2시간 전까지 경고 없이 취소 가능.
　 이후에는 대타 직접 구하거나, 이미 있는 대기자에게 참여 가능한지 직접 확인 후 취소 가능.
　 내전 시작 시간 30분 전 참여 인원 확정 

✅ 인원에 따른 진행방식 ‘내전규칙’ 채널 참고.
　 팀장 희망 여부랑 관계 없이 팀장 부족 시 누구나 팀장이 될 수 있음을 반드시 고려하고 신청하시기 바랍니다.

✅ 내전 인게임 전체 채팅 및 감정표현 관련 [내전규칙 9번] 참고해주세요.

✅ 부포지션도 작성 필수입니다. 괄호하고 실력 수준 적으셔도 됩니다. ex ( 미드는 실버수준입니다 )
　 부포지션 미작성 시 양식 안맞춰주신 걸로 간주하고 선착순 후순위 배치될 수 있습니다.

✅ 위 규칙들이 제대로 이루어지지 않았을 때에는 경고가 부여됩니다. 충분히 숙지하고 내전에 참여해주시길 바랍니다.
